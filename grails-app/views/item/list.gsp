			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="brand" title="${message(code: 'item.brand.label', default: 'Brand')}" />
				...
				<g:each in="${itemInstanceList}" status="i" var="itemInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${itemInstance.id}">${fieldValue(bean: itemInstance, field: "brand")}</g:link></td>
